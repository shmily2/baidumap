window.TILE_VERSION = {
  ditu: {
    normal: { version: "088", updateDate: "20210401" },
    satellite: { version: "009", updateDate: "20210401" },
    normalTraffic: { version: "081", updateDate: "20210401" },
    satelliteTraffic: { version: "083", updateDate: "20210401" },
    mapJS: { version: "104", updateDate: "20210401" },
    satelliteStreet: { version: "083", updateDate: "20210401" },
    earthVector: { version: "001", updateDate: "20210401" },
  },
  webapp: {
    high_normal: { version: "001", updateDate: "20210401" },
    lower_normal: { version: "002", updateDate: "20210401" },
  },
  api_for_mobile: {
    vector: { version: "002", updateDate: "20210401" },
    vectorIcon: { version: "002", updateDate: "20210401" },
  },
};
...
(function() {
  ...
  A.UK = (function() {
    ...
    a.prototype = {
      ...
      move: function(a) {
        ...
        if (
          10 <
            Math.abs((this.Lk ? a.touches[0].clientX : a.clientX) - this.pu) ||
  ...
  D.V0 =
    ...
    function() {
      D.version &&
        D.version >= 1.5 &&
        qa(D.td + "?qt=verify&ak=" + ra, function(a) {
          if (a && a.error !== 0) {
  ...
  A.extend(Oa.prototype, {
    ...
    Rg: function(a, b) {
      if (
        ...
        c &&
          ((c = this.no($a(c, this.M.Ma), this.Bc)),
          this.qk(
            this.width / 2 - c.x,
            this.height / 2 - c.y,
            this.pg(c, this.Bc),
    ...
    C_: function(a) {
      a === cb || a === Ua
        ? (this.By(p), this.VN(t), (this.M.yg = t), (this.M.yk = t))
        : (this.By(t), this.VN(p), (this.M.yg = p), (this.M.yk = p));
    },
    zf: function(a) {
      var b = this;
      if (a instanceof Q || a instanceof L) b.zi(a, { noAnimation: p });
      else if (db(a))
        if (b.Ua === Sa) {
          var c = I.hC[a];
          c && ((pt = c.o), b.zf(pt));
    ...
    zb: function() {
      return this.As && this.As instanceof N
        ? new N(this.As.width, this.As.height)
    ...
    r5: function(a, b) {
      ...
      this.Ua === Sa &&
        c &&
        ((a.x += this.offsetX), (a.y += this.offsetY), ib.qK(a, this, b));
    },
    le: function(a) {
    ...
    ht: function(a, b) {
      ...
      if (
        !a ||
        (!a instanceof jb && 0 === a.length) ||
        (a instanceof jb && a.Aj())
      )
        return c;
      var e = [];
    ...
    T3: function(a, b) {
      ...
      b.styleJson
        ...
        : b.styleId &&
          (i += "styles=" + encodeURIComponent(c.EF(c.a0, parseInt(a, 10))));
    ...
    eM: function(a) {
      a
        ? (this.ys && this.ys.If === a) ||
          (this.cg(this.ys),
          (this.ys = new sb({ geotableId: a })),
          this.Ue(this.ys))
        : this.cg(this.ys);
    },
    Vd: function() {
    ...
    Fo: function(a, b, c) {
      ...
      if (b && 0 !== b.length)
        return (
          (c = c || {}),
          (this.Ni[a] = this.Ni[a] || { polygon: [], polyline: [] }),
          (this.Ni = this.Ni || {}),
  ...
  function Bb(a) {
    var b = gb();
    b >= a.Qz
      ? (bb(a.m.Ba) && a.m.Ba(a.m.dc(1)),
        bb(a.m.finish) && a.m.finish(),
        0 < a.fg.length &&
          ((b = a.fg[0]), (b.fg = [].concat(a.fg.slice(1))), b.start()))
      : ((a.yy = a.m.dc((b - a.Su) / a.m.duration)),
        bb(a.m.Ba) && a.m.Ba(a.yy),
        a.FF ||
  ...
  A.ga.Xe
    ? (A.extend(I, {
      ...
      A.platform.pM && (I.fontFamily = "arial,simsun,sans-serif"))
    : A.ga.Lw || A.ga.xy
    ? A.extend(I, {
          ...
          for (var c = a.target || a.srcElement; c != b; ) {
            Ub(b.EE, function(b, i) {
              RegExp(i.filter).test(c.getAttribute("filter")) &&
                i.Rs.call(c, a, c.getAttribute("filter"));
            });
            c = c.parentNode;
          }
        },
    ...
    void (function(a, b, c) {
      ...
      if (!B || !B.Xo) {
        ...
        y.prototype.set = function(a, b) {
          if ("string" == typeof a)
            "protocolParameter" == a &&
              (b = w({ postUrl: q, protocolParameter: q }, b)),
              (this.Ps[a] = b);
      ...
      if (v && v.Ch && m() < v.Ch) {
        var C = ["Moz", "O", "ms", "Webkit"],
          ...
          xj = function() {
            return (
              !!b.createElementNS &&
              !!b.createElementNS("http://www.w3.org/2000/svg", "svg").R2
            );
          },
          yj = function() {
            return !!a.B1;
  ...
  yc.prototype.contains = function(a) {
    return a.lng > this.Gg.lng &&
      ...
      a.lat < this.Ng.lat
      ? oc
      : Math.abs(a.lng - this.Gg.lng) < pc ||
        Math.abs(a.lng - this.Ng.lng) < pc ||
        Math.abs(a.lat - this.Gg.lat) < pc ||
        Math.abs(a.y - this.Ng.lat) > pc
      ? 2
      : nc;
  };
  ...
  function vc(a) {
    ...
    for (var b = 0, c = mc, e = 0, f = new yc(), g = 0, e = 0; e < ac; ++e)
      dc[e] <= a.lat
        ? dc[(e + 1) % ac] > a.lat &&
          0 <
            Bc(
              { lng: cc[e], lat: dc[e] },
              { lng: cc[(e + 1) % ac], lat: dc[(e + 1) % ac] },
              a
            ) &&
          ++g
        : dc[(e + 1) % ac] <= a.lat &&
    ...
    if ((0 === g ? nc : oc) === nc) {
      for (g = 0; g < ac; ++g)
        if (
          ((e = new zc(cc[g], dc[g], cc[(g + 1) % ac], dc[(g + 1) % ac])),
          (f.Gg.lng = e.$x.Gg.lng - 0.5),
          (f.Gg.lat = e.$x.Gg.lat - 0.5),
          (f.Ng.lng = e.$x.Ng.lng + 0.5),
          (f.Ng.lat = e.$x.Ng.lat + 0.5),
          f.contains(a) !== nc)
        ) {
          var i;
          var k = e.mu.lng,
          ...
          i = o - m;
          var s = k - n;
          !(Math.abs(i - 0) > pc) && !(Math.abs(s - 0) > pc)
            ? (i = e.mu)
            : ((k = n * m - k * o),
              (m = s * a.lng - i * a.lat),
              (n = i * i - s * s),
              (i = { lng: (s * m - i * k) / n, lat: -(i * m + s * k) / n }));
          s = 180;
          k = 90;
          m = -180;
          n = -90;
          ...
          i.lng <= m && i.lng >= s && i.lng <= n && i.lat >= k
            ? ((e = a.lat * jc),
              ...
              -1 > e ? (e = -1) : 1 < e && (e = 1),
              (e = Math.acos(e) * qc))
            : ((i = Ac(a, e.mu)), (e = Ac(a, e.ex)), (e = i < e ? i : e));
          e < c && (c = e);
        }
      c < mc && (b = (mc - c) / mc);
    } else b = 1;
  ...
  function qa(a, b) {
    ...
    var a = a + "&v=3.0&seckey=" + pa,
      e = H("script", { type: "text/javascript" });
    e.charset = "utf-8";
    e.src = a;
    e.addEventListener
      ? e.addEventListener(
  ...
  A.object.extend(Wa, {
    ...
    nK: function(a) {
      if (a && this.pL()[a])
        for (var a = this.pL()[a], b = 0; b < a.length; b++)
          this.nK(a[b]), this.Xd.El[a[b]] || this.zN(a[b]);
    },
    zN: function(a) {
      for (var b = 0; b < this.Xd.Gn.length; b++)
        if (this.Xd.Gn[b] == a) return;
      this.Xd.Gn.push(a);
    },
    g_: function(a, b) {
      var c = this.qb(a);
    ...
    rV: function(a, b) {
      for (var c = this.Xd.bw, e = p, f = 0, g = c.length; f < g; f++)
        "" == c[f].IE && (c[f].RM == a ? (c[f].IE = b) : (e = t));
      e && this.WK();
    },
    WK: function() {
      for (var a = this.Xd.bw, b = 0, c = a.length; b < c; b++)
        this.g_(a[b].RM, a[b].IE);
      this.Xd.bw.length = 0;
    },
  });
  function R(a, b) {
  ...
  A.extend(Ec.prototype, {
    ...
    Me: function(a) {
      !this.R &&
        this.initialize && bb(this.initialize) &&
    ...
    wc: function(a) {
      if (this.v2 || !ab(a) || isNaN(a) || a < Fc || 3 < a)
  ...
  A.object.extend(Pc.prototype, {
    ...
    $E: function(a) {
      if (this.Ke[a]) {
        for (var b = 0, c = this.Da.length; b < c; b++)
          this.Da[b] &&
            "divider" == this.Da[b].Nb && this.Da[b].Uj == a &&
  ...
  A.object.extend(jb.prototype, {
    ...
    Ub: function(a) {
      return !(a instanceof jb) || this.Aj()
        ? t
    ...
    sf: x("Hl"),
    GV: function(a) {
      return !(a instanceof jb) || this.Aj() || a.Aj()
        ? t
        : a.Te > this.Te && a.Ne < this.Ne && a.ee > this.ee && a.be < this.be;
    },
    Qb: function() {
      return this.Aj()
        ? q
        : new Q((this.Te + this.Ne) / 2, (this.ee + this.be) / 2);
    },
    ot: function(a) {
      if (
        !(a instanceof jb) ||
        ...
        Math.max(a.ee, a.be) < Math.min(this.ee, this.be) ||
        Math.min(a.ee, a.be) > Math.max(this.ee, this.be)
      )
        return q;
    ...
    ns: function(a) {
      return !(a instanceof Q || a instanceof L) || this.Aj()
        ? t
        : a.lng >= this.Te &&
            a.lng <= this.Ne &&
            a.lat >= this.ee &&
    ...
    LF: function() {
      return this.Aj()
        ? new Q(0, 0)
        : new Q(Math.abs(this.Ne - this.Te), Math.abs(this.be - this.ee));
    },
  });
  function Q(a, b) {
  ...
  A.extend(Wc.prototype, {
    Me: function(a) {
      if (!this.ca && bb(this.initialize) && (this.ca = this.initialize(a)))
  ...
  Zc.OE = [0.09, 0.005, 1.0e-4, 1.0e-5];
  A.extend(Zc.prototype, {
    ...
    jn: function(a, b) {
      b &&
        this.ja[a] &&
        ((this.kf.length = 0), (this.ja[a] = new Q(b.lng, b.lat)), this.Hh());
    },
    ...
    uX: function() {
      for (var a = [], b = 0; b < this.ja.length - 1; b++)
        var c = this.kV(this.ja[b], this.ja[b + 1]), a = a.concat(c);
  ...
  A.extend($c.prototype, {
    Oj: function() {
      ...
      "none" != a.borderColor &&
        c.push("border:" + a.Vx + "px " + a.YY + " " + a.AM + ";");
      c.push(
    ...
    initialize: function(a) {
      ...
      this.Oj();
      this.ca &&
        A.V(this.ca, J() ? "touchstart" : "mousedown", function(a) {
          na(a);
        });
      return this.ca;
    },
    draw: function() {
      ...
      this.K.Ga = new N(
        -Math.round(this.K.width / 2) - Math.round(this.K.Vx),
        -Math.round(this.K.height / 2) - Math.round(this.K.Vx)
      );
  ...
  function cd(a, b, c, e) {
    a &&
      ...
      (this.$K = e ? !!e : t),
      (this.$c = []),
      (this.f0 = a instanceof bd ? a : q),
      (this.EI = b === l ? p : !!(b.indexOf("%") + 1)),
      (this.jk = isNaN(parseFloat(b))
        ? 1
        : this.EI
        ? parseFloat(b) / 100
        : parseFloat(b)),
  ...
  A.extend(ed.prototype, {
    ...
    va: function(a) {
      if ((a instanceof Q || a instanceof L) && !this.tx())
    ...
    XN: function(a) {
      this.point = (this.ho = a)
        ? (this.K.position = a.bk())
        : (this.K.position = q);
    },
    tx: function() {
      return this.ho || q;
  ...
  A.extend(W.prototype, {
    ...
    bk: x("point"),
    ma: function() {
      return this.point instanceof Q || this.point instanceof L
        ? this.map
          ? eb(this.point, this.map.M.Ma)
    ...
    va: function(a) {
      if (a instanceof Q || a instanceof L)
        this.point = this.map ? $a(a, this.map.M.Ma) : new L(a.lng, a.lat);
    },
    Di: function(a, b) {
      this.K.rE = !!a;
      a && (this.NG = b || 0);
  ...
  function od(a) {
    var b =
        ...
        (a.UU || a.F6 || a.c5 || a.d5 || a.h5 || a.UU || 1),
      c = a.canvas.width,
      e = a.canvas.height;
    a.canvas.width = c * b;
    a.canvas.height = e * b;
  ...
  A.extend(pd.prototype, {
    ...
    jn: function(a, b) {
      this.Ao[a] &&
        ((this.Ao[a] = new Q(b.lng, b.lat)),
        (this.ja[a] = new Q(b.lng, b.lat)),
        0 == a &&
          !this.ja[0].Ub(this.ja[this.ja.length - 1]) &&
          (this.ja[this.ja.length - 1] = new Q(b.lng, b.lat)),
        this.Hh());
    },
    $e: function() {
      var a = this.Ao;
  ...
  A.extend(td.prototype, {
    ...
    KL: function(a, b, c) {
      ...
      for (e = a.childNodes.length; n < e; n++)
        (y = a.childNodes[n]), (y.mr = t), this.Ve.push(y);
      ...
      for (e = this.Ve.length; n < e; n++)
        (s = this.Ve[n]), s.mr || this.We.push(s);
      this.IF = [];
          ...
          o
            ...
            : (0 < this.We.length
                ...
                : ((o = document.createElement("canvas")),
                  ...
                  (s.width = f + c + "px"),
                  (s.height = f + c + "px"),
                  this.RY() && (s.WebkitTransform = "scale(1.001)"),
      ...
      if (!this.map.M.yg) {
        ...
        if (b.map.ya() == Sa)
          Wa.load(
            ...
            function() {
              b.map.Ob ||
                ((b.map.Ob = Sa.Ck(b.map.lh)), (b.map.Mw = Sa.mL(b.map.Ob)));
              b.kI();
            },
            p
          );
    ...
    kI: function(a) {
      ...
      for (var k = 0; k < c; k++) {
        ...
        if (m.Gw) {
          ...
          if (this.map.Vd()) {
            ...
            (n.style.display = "block"),
              ...
              this.map.dispatchEvent(new P("vectorchanged"), { isvector: t });
        }
        if (!m.b2 && !((m.Rx && !this.map.Vd()) || (m.nM && this.map.Vd()))) {
          ...
          z = [];
          for (e.KB = []; v < y; v++)
            for (B = o; B < f; B++) z.push([v, B]), e.KB.push({ x: v, y: B });
          ...
          if (n && n.length)
            for (var o = i[k][1], s = 0; s < o.length; s++) {
              ...
              f.Uc(v[0], c) &&
                ...
                (v = v["cache" + c]),
                f.P.Fo(b.canvas.id, v, { type: "polygon", Xb: m, style: n }),
                this.AW(b, v, n, c));
            }
        }
    },
  ...
  var Qd = {
      ...
      for (
        ...
        for (
          ...
          a[w][E].tM
            ...
            : a[w][E].tY
            ? this.rN(a[w][E].tY, z, e, b, c, B, C, i, k, s, v, y, p, window.A4)
            : this.GZ(a[w][E].WY, z, e, b, c, B, C, i, k, s, v, y, f);
        m.push(y);
      }
              ...
              if (E) {
                ...
                this.Ks(b, c, e, E, function(a) {
                  for (var c = 0; c < a.Bf.length; c++)
                    F.NK(b, a.Bf[c].ie, a.Bf[c].je, a.Bf[c].text, a.style, e);
                });
              } else this.Ks(b, c, e);
            if (c.style && !E)
              for (E = 0; E < c.Bf.length; E++)
                this.NK(b, c.Bf[E].ie, c.Bf[E].je, c.Bf[E].text, c.style, e);
          } else if ("line" === c.type)
    ...
    Ks: function(a, b, c, e, f) {
      var g = b.Be;
      if ("lanche" !== g)
        if (Qd.Jx[g]) this.KK(a, b, Qd.Jx[g], e, f);
        else if ((c = c.tL(g))) {
          var i = new Image();
    ...
    wW: function(a, b, c, e, f, g, i, k, m) {
      ...
      0 < k.Bx &&
        ((a.lineWidth = k.Bx), (a.strokeStyle = k.UL), a.strokeText(f, -g, -i));
      a.fillText(f, -g, -i);
      a.restore();
    },
    NK: function(a, b, c, e, f, g) {
      ...
      a.fillStyle = f.cL;
      0 < f.Bx &&
        ((a.lineWidth = f.Bx), (a.strokeStyle = f.UL), a.strokeText(e, b, c));
      a.fillText(e, b, c);
    },
    mx: function(a, b) {
      var c = a.fontSize / 2,
  ...
  var Rd = ["round", "butt", "square"],
    ...
    Td = {
      daojiao: [
        { stroke: "#FF6600", Db: 1, Bb: "round", Cb: "round", yd: [4, 3] },
      ],
      daojiao_bai: [
        { stroke: "#f5f3f0", Db: 1, Bb: "round", Cb: "round", yd: [4, 3] },
      ],
      junhuoxian: [
        { stroke: "#DB7093", Db: 1, Bb: "round", Cb: "round", yd: [4, 3] },
      ],
      lundu: [
        { stroke: "#5c91c5", Db: 1, Bb: "round", Cb: "round", yd: [10, 11] },
      ],
      shengjie: [
        { stroke: "#737373", Db: 1, Bb: "round", Cb: "round", yd: [6, 3] },
      ],
      weidingguojie: [
        { stroke: "#aea08a", Db: 1, Bb: "round", Cb: "round", yd: [4, 3] },
      ],
      weidingguojie_guowai: [
        { stroke: "#a29e96", Db: 2, Bb: "round", Cb: "round", yd: [4, 3] },
      ],
      weidingguojie_guonei: [
        { stroke: "#b5a37c", Db: 2, Bb: "round", Cb: "round", yd: [4, 3] },
      ],
    },
    Ud = {};
  function Vd(a, b, c) {
    if (/^tielu|^MapRes\/tielu/.test(a)) {
      ...
      if ((4 <= b && 9 >= b) || (10 <= b && 16 >= b))
        return [
          { stroke: e, Db: 1.5, Bb: "butt", Cb: "round", yd: [10, 11] },
          { stroke: f, Db: 2, Bb: "round", Cb: "round" },
        ];
      if (17 <= b && 18 >= b)
        return [
          { stroke: e, Db: 2.5, Bb: "butt", Cb: "round", yd: [15, 16] },
          { stroke: f, Db: 5, Bb: "round", Cb: "round" },
        ];
      if (19 <= b && 20 >= b)
        return [
          { stroke: e, Db: 4.5, Bb: "butt", Cb: "round", yd: [25, 26] },
          { stroke: f, Db: 5, Bb: "round", Cb: "round" },
        ];
    } else if (
      ...
      if (12 <= b && 16 >= b)
        return [
          { stroke: "#868686", Db: 1, Bb: "round", Cb: "round", yd: [7, 4] },
        ];
      if ((17 <= b && 18 >= b) || (19 <= b && 20 >= b))
        return [
          { stroke: "#6e6e6e", Db: 1, Bb: "round", Cb: "round", yd: [7, 4] },
        ];
    } else if (/^tongdaomian|^MapRes\/tongdaomian/.test(a)) {
      if (17 === b)
        return [
          { stroke: "#e5e5e5", Db: 4, Bb: "square", Cb: "round" },
          { stroke: "#a8a8a8", Db: 6, Bb: "square", Cb: "round" },
        ];
      if (18 === b)
        return [
          { stroke: "#e5e5e5", Db: 6, Bb: "square", Cb: "round" },
          { stroke: "#a8a8a8", Db: 8, Bb: "square", Cb: "round" },
        ];
      if (19 <= b && 21 >= b)
        return [
          { stroke: "#e5e5e5", Db: 8, Bb: "square", Cb: "round" },
          { stroke: "#a8a8a8", Db: 10, Bb: "square", Cb: "round" },
        ];
    } else if (
      ...
      if (17 === b)
        return [
          { stroke: "#e5e5e5", Db: 4, Bb: "butt", Cb: "round", yd: [2, 1] },
          { stroke: "#bebebe", Db: 6, Bb: "butt", Cb: "round" },
        ];
      if (18 === b)
        return [
          { stroke: "#e5e5e5", Db: 6, Bb: "butt", Cb: "round", yd: [3, 1] },
          { stroke: "#bebebe", Db: 8, Bb: "butt", Cb: "round" },
        ];
      if (19 <= b && 21 >= b)
        return [
          { stroke: "#e5e5e5", Db: 8, Bb: "butt", Cb: "round", yd: [4, 2] },
          { stroke: "#bebebe", Db: 10, Bb: "butt", Cb: "round" },
        ];
    } else if (/^guojietianqiao|^MapRes\/guojietianqiao/.test(a))
      return 18 === b
        ? [
            { stroke: "#ffffff", Db: 6, Bb: "butt", Cb: "round", yd: [4, 2] },
            { stroke: "#bebebe", Db: 8, Bb: "butt", Cb: "round" },
          ]
        : [
            { stroke: "#ffffff", Db: 8, Bb: "butt", Cb: "round", yd: [4, 2] },
            { stroke: "#bebebe", Db: 10, Bb: "butt", Cb: "round" },
          ];
  ...
  var Wd = {
    ...
    HO: function(a, b, c, e, f, g, i) {
      for (var k = 0; k < a.length; k++) {
        ...
        if (n && n.length && (!i || n[0].borderWidth))
          if (!n[0].gp || Vd(n[0].gp, b, this.da))
            for (var o = a[k][1], s = 0; s < o.length; s++) {
              var v = o[s][3];
              g.Uc(v[0], b) &&
                (v["cache" + b] || (v["cache" + b] = g.Vm(v[1], b, c, f)),
                (v = v["cache" + b]),
                g.P.Fo(e.canvas.id, v, { type: "polyline", Xb: m, style: n }),
                this.xW(e, v, n, i, b));
            }
      }
    },
    ...
    xW: function(a, b, c, e, f) {
      c = c[0];
      if (!e && c.gp && Vd(c.gp, f, this.da))
        this.FW(a, b, c, Vd(c.gp, f, this.da));
      else {
        a.beginPath();
        a.moveTo(b[0], b[1]);
  ...
  he.prototype = {
      ...
      if (!window[o + "StyleBody"] && 100 > m)
        ...
        if (a[0])
          for (o = 0; o < a[0].length; o++)
            (v = a[0][o]), v[0] === Zd && Nd.drawPoly(v, s, f, g, this);
        17 <= this.P.la()
          ? (n.MK(a, s, f, g, i, c, e), (b.Tn = p))
          : setTimeout(function() {
              if (!b.oH) {
                n.MK(a, s, f, g, i, c, e);
                b.Tn = p;
      ...
      if (a[0])
        for (var g = 0; g < a[0].length; g++) {
          var i = a[0][g],
            k = i[0];
          k === Yd
            ? Wd.drawLink(i, b, c, e, this)
            : k === be
            ? Wd.drawLink(i, b, c, e, this)
            : k === ae
            ? (Nd.drawGaoqingRoadBorder(i, b, c, e, this),
              Nd.drawGaoqingRoadFill(i, b, c, e, this))
            : 18 === k
            ? window[f + "zoomFrontStyle"] &&
              window[f + "zoomFrontStyle"][c] &&
                "off" !==
                  window[f + "zoomFrontStyle"][c].bmapRoadarrowVisibility &&
              Od.drawArrow(i, b, c, e, Math.pow(2, c - ge[c].Sc), this)
            : k === $d
            ? Pd.drawHregion(i, b, c, e, this)
            : 19 === k && Wd.drawSingleTexture(i, b, c, e, this);
        }
    },
    LK: function(a, b, c, e, f, g, i) {
      ...
      !window[m + "StyleBody"] && 100 > i
        ...
        : (fe || (fe = b), (a.NZ = Qd.parse(a, c, e, this, f)));
    },
    wj: function(a, b, c, e) {
      var f = a + "-" + b + "-" + c;
    ...
    CZ: function(a) {
      for (var b in a)
        return (a = a[b]), { color: this.Lg(a[0]), pY: a[1], Be: a[2] };
    },
    Lg: function(a) {
      var b = a;
      if (ee[b]) return ee[b];
          ...
          if (k)
            for (var m = 0; m < k.length; m++)
              for (var n = k[m], o = 0; o < n.length; o++)
                if (
                  ((a = n[o]),
                  !a.vt && a.lt && b > a.Zf && b < a.ui && c > a.$f && c < a.vi)
                ) {
                  b = a.lt;
                  b = {
                    type: 9,
  ...
  function ke(a, b, c, e, f) {
    ...
    window[y] = function(a) {
      ...
      if (a) {
        ...
        if (o !== t) {
          ...
          if (m.M.yk) {
            if (
              ((k.nh[f.id] = { W0: a, k0: f, nm: b, an: c, CE: n }),
              k.ow.PC.OC(a, f, b, c, n, k.Hd.Nd(n), k.Hd.LD(n), k.fb.aE),
              k.fb.wF)
            ) {
              n = [];
              n.l0 = [b, c, e];
              if (a[0])
                for (o = 0; o < a[0].length; o++)
                  a[0][o][0] === Xd && n.push({ tM: a[0][o] });
              if (a[2])
                for (o = 0; o < a[2].length; o++) n.push({ WY: a[2][o] });
              f.HF = n;
              k.vs.push(n);
              k.Px === t && k.Bt--;
              (0 === k.Bt || k.Px === p) && je(k);
    ...
    i[g].dl = setTimeout(function() {
      3 > i[g].JN
        ? (i[g].JN++, (i[g].status = "init"), ke(k, b, c, e, f))
        : (i[g] = q);
    }, 4e3);
  }
  function je(a) {
  ...
  function Ra(a, b) {
    ...
    this.eh = [];
    this.yr = [];
    "cvsRender" == this.mk || Qa()
      ? ((this.fk = 90), (this.hk = -90))
      : "cssRender" == this.mk && ((this.fk = 45), (this.hk = -45));
    this.Dr = t;
    var f = this;
    this.eo = function() {
      this.mk === "flashRender"
    ...
    this.m.IS !== p &&
      (this.eo(), D.Cq("cus.fire", "count", "z_loadpanoramacount"));
    this.BT(this.R);
  ...
  A.extend(Ra.prototype, {
    ...
    BT: function(a) {
      ...
      if ("absolute" === c || "relative" === c)
        if (((a = Za(a).zIndex), !a || "auto" === a)) b.zIndex = 0;
    },
    BX: x("co"),
    Zb: x("hb"),
    aY: x("hw"),
    ...
    Xc: function(a) {
      a != this.Rc &&
        ...
        a < lf && (a = lf),
        a != this.Rc && (this.Rc = a),
        "cssRender" === this.mk && this.xd(this.Oa));
    },
    uB: function() {
      if (this.P)
        for (var a = this.P.vx(), b = 0; b < a.length; b++)
          (a[b] instanceof W || a[b] instanceof ed) &&
            a[b].point &&
            this.ta.push(a[b]);
    },
    oF: ca("P"),
    ...
    gr: function() {
      return Ya() && !J() && "javascript" != this.m.panoramaRenderer
        ? "flashRender"
        : !J() && Sb()
        ? "cvsRender"
        : "cssRender";
  ...
  A.extend(pf.prototype, {
    ...
    Yn: function() {
      var a = 0,
        ...
        c;
      this.W &&
        ((b = this.W.ma()), (c = this.ma()) && !c.Ub(b) && (a = T.Ek(b, c)));
      return a;
    },
    aa: function() {
      ba("hide\u65b9\u6cd5\u672a\u5b9e\u73b0");
      ...
      function a(a) {
        if (a) {
          if (a.id != b.hw) {
            ...
            a.jm
              ? (b.Gj({ haveBreakId: p }),
                Ya() && b.m.closeControl && A.U.show(b.jr))
              : A.U.aa(b.jr);
          }
        } else
  ...
  A.extend(yf, {
    lW: function(a, b, c) {
      ...
      b = { data: b };
      "position_changed" == a &&
        (b.data = yf.ae.Ej(new R(b.data.mercatorX, b.data.mercatorY)));
    ...
    fM: function(a, b, c, e) {
      if (!b || !c || !c.lngLat || !c.panoInstance) e();
        ...
        this.mo.fC(b, function(b) {
          b
            ? f.mo.tj(c.lngLat, Af.sP, function(b) {
                if (b && b.id) {
                  var g = b.id,
                    m = b.zh,
                    b = b.Ah,
  ...
  function gg(a, b) {
    ...
    c.options.fl
      ? (c.Rb.style[Lf] = "translate(" + c.x + "px," + c.y + "px)" + fg)
      : (c.Rb.style.cssText +=
  ...
  gg.prototype = {
    ...
    uQ: function() {
      !this.yh &&
        !this.il &&
          !(
            this.gm ||
            (this.zy == this.Rb.offsetWidth * this.scale &&
              this.Vp == this.Rb.offsetHeight * this.scale)
          ) &&
        this.refresh();
    },
    Rv: function(a) {
        ...
        ? (this[a + "ScrollbarWrapper"] ||
          ...
          "h" == a
            ? ((this.SL = this.TL.clientWidth),
              (this.kY = Cf.max(Cf.round((this.SL * this.SL) / this.zy), 8)),
              (this.jY.style.width = this.kY + "px"))
            : ((this.QO = this.RO.clientHeight),
              (this.R0 = Cf.max(Cf.round((this.QO * this.QO) / this.Vp), 8)),
              (this.Q0.style.height = this.R0 + "px")),
          this.oB(a, p))
        : this[a + "ScrollbarWrapper"] &&
          (Vf && (this[a + "ScrollbarIndicator"].style[Lf] = ""),
    ...
    oB: function(a, b) {
      ...
      this[a + "Scrollbar"] &&
        ...
        (this[a + "ScrollbarWrapper"].style[Qf] = "0"),
        (this[a + "ScrollbarWrapper"].style.opacity =
          b && this.options.Gx ? "0" : "1"),
        (this[a + "ScrollbarIndicator"].style[Lf] =
    ...
    $v: function(a) {
      ...
      if (this.enabled) {
        ...
        this.options.zoom &&
          Uf && 1 < a.touches.length &&
          ((e = Cf.abs(a.touches[0].pageX - a.touches[1].pageX)),
          (c = Cf.abs(a.touches[0].pageY - a.touches[1].pageY)),
          (this.w0 = Cf.sqrt(e * e + c * c)),
          (this.hy =
            Cf.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.YF) / 2 -
            this.x),
          (this.iy =
            Cf.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.ZF) / 2 -
            this.y),
    ...
    YS: function(a) {
      ...
      if (this.options.zoom && Uf && 1 < a.touches.length)
        (f = Cf.abs(a.touches[0].pageX - a.touches[1].pageX)),
        ...
        (6 > this.uw && 6 > this.vw) ||
          ...
          300 < i - this.startTime &&
            ((this.startTime = i), (this.pu = this.x), (this.qu = this.y)),
      ...
      if (!(Uf && 0 !== a.touches.length)) {
        ...
        if (b.il)
          ...
          if (b.yh) {
            ...
            g.Ia || i.Ia
              ? ((c = Cf.max(Cf.max(g.time, i.time), 10)),
                b.options.lu &&
                  ((g = e - b.ww),
                  (i = f - b.xw),
                  Cf.abs(g) < b.options.Ky && Cf.abs(i) < b.options.Ky
                    ? b.scrollTo(b.ww, b.xw, 200)
                    : ((g = b.hJ(e, f)),
                      (e = g.x),
                      (f = g.y),
                      (c = Cf.max(g.time, c)))),
                b.scrollTo(Cf.round(e), Cf.round(f), c))
              : b.options.lu
              ? ((g = e - b.ww),
                (i = f - b.xw),
                Cf.abs(g) < b.options.Ky && Cf.abs(i) < b.options.Ky
    ...
    po: function(a) {
      ...
      if (b == this.x && c == this.y) {
        if (
          (this.yh &&
            ((this.yh = t), this.options.fy && this.options.fy.call(this)),
          this.ni &&
            this.options.Gx &&
            ("webkit" == Ef && (this.TL.style[Qf] = "300ms"),
            (this.TL.style.opacity = "0")),
          this.Gi && this.options.Gx)
        )
          "webkit" == Ef && (this.RO.style[Qf] = "300ms"),
    ...
    zU: function(a) {
      ...
      if ("zoom" == b.options.YO) {
        if (
          ...
          e > b.options.mq && (e = b.options.mq),
          e != b.scale)
        )
          !b.Uy && b.options.Lp && b.options.Lp.call(b, a),
            b.Uy++,
    ...
    hJ: function(a, b) {
      ...
      a = this.bf[f];
      e = (e = Cf.abs(a - this.bf[this.vC]))
        ? 500 * (Cf.abs(this.x - a) / e)
        : 0;
      this.vC = f;
      f = this.xf.length - 1;
      for (c = 0; c < f; c++)
    ...
    refresh: function() {
      ...
      this.tn =
        this.options.tn &&
        ((!this.options.fV && !this.wp) || this.Vp > this.zn);
    ...
    scrollTo: function(a, b, c, e) {
      ...
      for (b = f.length; a < b; a++)
        f[a].YZ && ((f[a].x = this.x - f[a].x), (f[a].y = this.y - f[a].y)),
          this.Hj.push({ x: f[a].x, y: f[a].y, time: f[a].time || 0 });
      this.AB();
    },
    disable: function() {
      this.stop();
    ...
    zoom: function(a, b, c, e) {
      ...
      this.options.fl &&
        ...
        (this.Rb.style[Nf] = e + "ms"),
        (this.Rb.style[Lf] =
          "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + fg),
        (this.il = t));
    },
  };
  function Kf(a) {
  ...
  D.Rk(function(a) {
    ...
    a.addEventListener("position_changed", function() {
      a.m.visible &&
        a.m.albumsControl === p &&
        (b ? b.vy(a.Zb()) : ((b = new hg(a.m.albumsControlOptions)), b.za(a)));
    });
  ...
  A.extend(hg.prototype, {
    ...
    vy: function(a, b) {
      if (
        b ||
        !this.kk[this.bd] ||
        !(this.kk[this.bd].panoId == a && 3 !== this.kk[this.bd].recoType)
      ) {
        var c = this,
          e = this.EH(a);
        !b && -1 !== e && this.kk[e] && 3 !== this.kk[e].recoType
          ? this.Yp(e)
          : this.QX(function(a) {
              for (
                ...
                (e = a[o].catlog),
                  ...
                  l !== e &&
                    ("" === e && l !== k
                      ...
                      : (b[jg[e]] || (b[jg[e]] = []), b[jg[e]].push(a[o])));
              for (var v in b)
                m
                  ? n.push({ data: v + "F", index: v })
                  : n.push({ data: kg[v], index: v });
              c.$G = b;
              c.Ti = n;
              c.$i(a);
    ...
    QV: function() {
      if (this.Qi) (a = this.lL(this.Ti)), (this.sQ.innerHTML = a);
      else {
          ...
          if ((a = (a.srcElement || a.target).getAttribute("dataindex"))) {
            ...
            for (
              ...
              e[f].childNodes[0].getAttribute("dataindex") === a
                ...
                : A.U.rc(e[f], "pano_catlogLiActive");
          }
        });
        var a = H("div"),
          e = H("a"),
          ...
          i = H("span"),
          k = [
            "background:url(" + I.ua + "panorama/catlog_icon.png) no-repeat;",
    ...
    $i: function(a) {
      ...
      this.m.showCatalog &&
        (0 < this.Ti.length
          ? (Ya() ? this.QV() : this.TV(), (this.Yc.offsetLeft = 60))
          : (this.Os &&
              (this.R.removeChild(this.Os),
              (this.Os = q),
    ...
    yX: function(a) {
      for (
        ...
        (b = a[m]),
          ...
          3 === recoType
            ? Ya()
              ? ((this.Sz = b), (this.OW = e), a.splice(m, 1), m--)
              : ((b =
                  '<a href="javascript:void(0);" class="pano_photo_item" data-index="' +
                  m +
                  '"><img style="width:' +
  ...
  lg.prototype = {
    ...
    refresh: function() {
      ...
      this.mg &&
        (this.mg.children[0].style.marginTop = this.Ir.children[0].style.marginTop =
    ...
    scrollTo: function(a) {
      a =
        a < this.hh.offsetLeft
          ? Math.ceil((a - this.Ji - this.ko) / this.Qr) * this.Qr +
            this.ko +
            this.Ji -
            8
          : Math.ceil((a - this.Ji) / this.Qr) * this.Qr + this.Ji;
